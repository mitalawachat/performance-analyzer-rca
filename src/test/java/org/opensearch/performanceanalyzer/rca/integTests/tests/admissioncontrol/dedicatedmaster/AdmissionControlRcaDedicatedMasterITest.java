...
package org.opensearch.performanceanalyzer.rca.integTests.tests.admissioncontrol.dedicatedmaster;
...
import org.opensearch.performanceanalyzer.rca.integTests.tests.admissioncontrol.validator.AdmissionControlValidator;
...
public class AdmissionControlRcaDedicatedMasterITest {
    ...
    public void testAdmissionControlRca() {}
            ...
            tables = {
                @ATable(
                        ...
                        tuple = {
                            @ATuple(
                                    dimensionValues = AllMetrics.GCType.Constants.HEAP_VALUE,
                                    sum = HEAP_MAX_SIZE_IN_BYTE * 0.95,
                                    avg = HEAP_MAX_SIZE_IN_BYTE * 0.95,
                                    min = HEAP_MAX_SIZE_IN_BYTE * 0.95,
                                    max = HEAP_MAX_SIZE_IN_BYTE * 0.95),
                        })
            })
    @AMetric(
            name = Heap_Max.class,
    ...
    public static class HighHeapUsage {}
            ...
            tables = {
                @ATable(
                        ...
                        tuple = {
                            @ATuple(
                                    dimensionValues = AllMetrics.GCType.Constants.HEAP_VALUE,
                                    sum = HEAP_MAX_SIZE_IN_BYTE * 0.65,
                                    avg = HEAP_MAX_SIZE_IN_BYTE * 0.65,
                                    min = HEAP_MAX_SIZE_IN_BYTE * 0.65,
                                    max = HEAP_MAX_SIZE_IN_BYTE * 0.65),
                        })
            })
    @AMetric(
            name = Heap_Max.class,
    ...
    public static class LowHeapUsage {}
}
